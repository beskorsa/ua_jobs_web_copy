  ...
  return (
    <main className="page">
      <header className="page__header">
        ...
        <h1>Замість годин пошуку — добірка вакансій саме для тебе</h1>
        <p>
          Завантаж резюме, введи ключові слова або додай посилання на вакансію — AI проаналізує твої навички,
          підбере релевантні вакансії саме для тебе та підготує cover letter.
        </p>
      </header>
